 ...
 * @author coldilock
 */
public abstract class CustomVoidVisitor<A> implements VoidVisitor<A> {
    ...
    public void visit(final IfStmt n, final A arg) {
        /*
         * the original code will scan Condition, ThenStmt & the ElseStmt respectively,
         * we will inspect them in reverse.
         */
        n.getCondition().accept(this, arg);
    ...
    public void visit(final ObjectCreationExpr n, final A arg) {
        /*
         * We don't inspect the anonymous class inside the object creation expression
         * todo: fix anonymous class problem
         */
        // n.getAnonymousClassBody().ifPresent(l -> l.forEach(v -> v.accept(this, arg)));
        /*
         * Here, the parameter of the Constructor will be parsed
         */
        n.getArguments().forEach(p -> p.accept(this, arg));
        n.getScope().ifPresent(l -> l.accept(this, arg));
        n.getType().accept(this, arg);
